...
export function PromptGeneratorCard() {
  ...
  const [selectedPromptFormat, setSelectedPromptFormat] = useState<'comprehensive'>('comprehensive');
...
---
*Generated by Buildtrix with RAG Enhancement - ${new Date().toLocaleDateString()}*`;
