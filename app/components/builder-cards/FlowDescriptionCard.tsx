...
export function FlowDescriptionCard() {
  ...
  const generateFullNavigationPrompt = () => {
    ...
    return `# ${appIdea.appName} - App Flow & Navigation Description
...
---
*Generated by Builder Blueprint AI for ${appIdea.platforms.join('/')} development*
*Ready for use in: AI design tools, Figma plugins, FlutterFlow, Draftbit, and developer planning*`;
  ...
  const copyFullNavigationPrompt = async () => {
    try {
      ...
      const fullPrompt = generateFullNavigationPrompt();
